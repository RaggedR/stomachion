...
\begin{figure}[ht]
  ...
  \caption{Distribution of geometric tiling counts for random $n$-piece
    ...
    The $n = 14$ panel (Stomachion's piece count, highlighted) shows
    random sampling peaking at~$128$---the Stomachion's $2{,}144$ is
...
Surprisingly, this property is not rare. Table~\ref{tab:allirred}
shows that \emph{most} random dissections are all-irreducible at
every~$n$, with the fraction stabilising around $80\%$ from $n = 6$
onward. What makes the $n = 13$ champion remarkable is not its
irreducibility (which is generic) but achieving $120$~tilings while
maintaining it. The best all-irreducible dissection found by random
search grows slowly from $4$ ($n = 3$) to $96$ ($n = 14$--$16$).

\begin{table}[ht]
\centering
\caption{Prevalence of all-irreducible dissections (every tiling
  fault-free) among random $n$-piece convex lattice dissections.
  The fraction is stable at ${\sim}80\%$ for $n \geq 6$, showing
  that full irreducibility is the generic condition.
  The best all-irreducible count grows far more slowly than the
  total maximum (cf.\ Table~\ref{tab:distribution}).}
\label{tab:allirred}
\medskip
\begin{tabular}{@{}c r r r r@{}}
\toprule
$n$ & All-irred.\ & Valid & Fraction & Best count \\
\midrule
 3 &  99 & 200 & 50\% &  4 \\
 4 & 127 & 200 & 64\% &  8 \\
 5 & 150 & 200 & 75\% &  8 \\
...
16 &  69 &  86 & 80\% & 96 \\
\midrule
14${}^\star$ & \multicolumn{2}{c}{Stomachion} & 1.5\% & 32 \\
\bottomrule
\end{tabular}
\end{table}
