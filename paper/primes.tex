...
% FIGURE PLACEHOLDER: canonical Stomachion tiling on 12x12 grid,
% showing all 14 labeled pieces with vertices at integer lattice points.
% \begin{figure}[ht]
%   \centering
%   \includegraphics[width=0.5\textwidth]{stomachion_canonical.pdf}
...
% FIGURE PLACEHOLDER: histogram of log2(tiling count) for n=8 and n=10,
% showing the spike structure at integer values (powers of 2).
% \begin{figure}[ht]
%   \centering
%   \includegraphics[width=0.7\textwidth]{distribution_histogram.pdf}
%   \caption{Distribution of $\log_2(\text{tiling count})$ for random
%     $n$-piece dissections at $n = 8$ (left) and $n = 10$ (right).
%     The concentration at integer values reflects the power-of-two
%     structure.}
%   \label{fig:histogram}
% \end{figure}
...
Section~\ref{sec:stomachion_verify} to each of the $17{,}152$ raw
...
irreducible core, full participation, balanced piece sizes, and
diversity of piece shapes. It achieves this through the elegant
mechanism of optional fault lines: the natural construction lines of
the square create a web of potential decompositions that collectively
generate $536$ tilings, of which $32$ are genuinely irreducible and all
$14$ pieces participate across the full solution space.
