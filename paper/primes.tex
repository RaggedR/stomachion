...
\begin{figure}[ht]
  ...
  \caption{Distribution of geometric tiling counts for random $n$-piece
    convex lattice dissections of the $12 \times 12$ square ($500$~trials
    per~$n$). Amber bars: total geometric tilings. Green bars: irreducible
    (fault-free) tilings only. The $x$-axis shows the number of solutions;
    the $y$-axis shows the fraction of dissections. Note the concentration
    on powers of two and the growing gap between total and irreducible
    counts as $n$ increases.}
